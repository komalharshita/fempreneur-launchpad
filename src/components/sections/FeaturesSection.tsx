...
<SectionWrapper id="features">
    ...
    <FadeIn key={feature.title} delay={i * 80}>
          <div className="card-premium group flex h-full flex-col p-6">
            ...
            <a href={feature.href} className="mt-4 inline-block font-subheading text-sm font-medium text-primary opacity-0 transition-all duration-300 group-hover:opacity-100" aria-label={`Learn more about ${feature.title}`}>
              Learn More →
            </a>
          </div>
        </FadeIn>

...
const staticShowcases = [
  { business_name: "Ananya's Crochet Studio", founder_name: "Ananya Sharma", description: "Handmade crochet bags and accessories crafted with love.", image_url: "https://images.unsplash.com/photo-1621600411688-4be93cd68504?w=800&h=500&fit=crop", website_url: "#" },
        ...
        <SectionWrapper>
          <FadeIn>
            <div className="text-center">
              <h1>Women Entrepreneurs Showcase</h1>
        ...
        <SectionWrapper className="section-rose">
          <FadeIn>
            <div className="mx-auto max-w-xl">
              <div className="text-center">
                <h2>Share your business with the community</h2>
